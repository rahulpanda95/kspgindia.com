...
$q = $_GET["q"];
echo "<strong>Showing Website Visitors for ".$q."</strong>";
...
echo "<br><strong>Total number of Visitors for the Day : </strong>".$result->num_rows."<br><br>";

if($result->num_rows==0)
{
  echo "<h3 style='color: darkred'>No Data Found for the Day</h3>";
}
else {
    echo "<table border='1'>
    <tr>
