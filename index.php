        ...
        <div class="classy-nav-container breakpoint-off">
            <div class="container">
                ...
                <nav class="classy-navbar justify-content-between" id="viralnewsNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="https://kspgindia.com/index.php?page=home"><img src="img/core-img/kspg_india_logo_resiged.png" alt="Logo" height="100" width="100"></a>
...
$sql = "INSERT INTO rahulpan_kspg.visitors (visit_date, visit_time, page, ip, isp, org, longitude, latitude, country_code, country_name, continent_code, currency_code, currency_name)
