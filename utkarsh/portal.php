        ...
        <div class="row text-center text-xs-center text-sm-left text-md-left">
            <div class="col-xs-12 col-sm-4 col-md-4">
                ...
                <ul class="list-unstyled quick-links">
                    <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Information System</a></li>
                    <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Attendance System</a></li>
                    <li><a href="javascript:void();"><i class="fa fa-angle-double-right"></i>Apply for Leave</a></li>
